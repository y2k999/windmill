...
class OpenGraph implements Iterator
{
	...
	/**
		Fetches a URI and parses it for Open Graph data, returns false on error.
		@param $URI
			URI to page to parse for Open Graph data
		@return
			OpenGraph
	 */
	...
	/**
		...
		@return boolean
			Check if the page has location data
	 */
