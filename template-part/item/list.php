...
<!-- =============== 
	<item-list>
 =============== -->
<li class="<?php echo apply_filters("_class[{$index}][item][unit]",esc_attr('uk-card')); ?>">
	...
	<?php if(has_action(HOOK_POINT['item'][$index]['header'])) : ?>
		<div class="<?php echo apply_filters("_class[{$index}][item][header]",esc_attr('uk-card-header')); ?>">
			...
			/**
				@hooked
					_fragment_meta::__the_list()
					_fragment_title::__the_list()
				@reference
