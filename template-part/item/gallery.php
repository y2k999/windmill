...
/**
 * @since 1.0.1
 * 	Display post in gallery format.
 * @reference
...
<div class="<?php echo apply_filters("_class[{$index}][item][unit]",esc_attr('uk-card')); ?>">
	...
	<?php if(has_action(HOOK_POINT['item'][$index]['image'])) : ?>
		<div class="<?php echo apply_filters("_class[{$index}][item][image]",esc_attr('uk-card-media')); ?>">
			<?php
			/**
				@hooked
					_fragment_image::__the_gallery()
				@reference
