...
<!-- =============== 
	<item-card>
 =============== --> 
<div class="<?php echo apply_filters("_class[{$index}][item][unit]",esc_attr('uk-card uk-padding-small')); ?>">

	<?php if(has_action(HOOK_POINT['item'][$index]['image'])) : ?>
		<div class="<?php echo apply_filters("_class[{$index}][item][image]",esc_attr('uk-card-media-top')); ?>">
			<?php
			/**
				@hooked
					_fragment_image::__the_card()
				@reference
